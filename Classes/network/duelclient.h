...
#include "network.h"
#include "../gui/YGOGameConfig.h"
#include "../gui/YGOClientCard.h"
#include "../gui/YGOImageManager.h"
#include "../gui/YGONetworkEventAdapter.h"
...
private:
	...
	static mtrandom rnd;
public:
	static bool StartClient(unsigned int ip, unsigned short port, CLENT_EVT_PARAM_COMPAT* param);
