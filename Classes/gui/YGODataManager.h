...
#ifndef YGODATAMANAGER_H_
#define YGODATAMANAGER_H_
...
class YGODataManager {
public:
	static YGODataManager* sharedDataManager();
	YGODataManager(): _datas(8192), _strings(8192) {}
